---
name: code-search
description: "Use when searching source code with ripgrep, ast-grep, semgrep, LSP/ctags, or comby: text/regex, structural/AST patterns, symbol definitions/references/callers, code changed in git history, rewrites, or size/complexity metrics."
license: MIT
