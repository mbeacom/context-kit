---
name: context-budget
description: "Use when deciding WHERE guidance should live — always-on memory (CLAUDE.md / AGENTS.md), a path-scoped rule, a skill, a subagent, an MCP server, or a hook — and how to keep the always-on budget small."
license: MIT
metadata:
  author: Mark Beacom
  version: "0.1.0"
