...
- **Fix: `runtime-investigator` now registers on GitHub Copilot CLI.** Its `skills`
  frontmatter preloaded `runtime-evidence` and `verify-before-trust` as a comma-separated
