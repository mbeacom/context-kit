...
description: "Use when you need to check whether claims are true before relying on them — an AI answer, a plan's assumptions, or a PR description against the codebase, with per-claim verdicts and evidence."
license: MIT
metadata:
  author: Mark Beacom
  version: "0.1.0"
